...
package @namespace@.events
{
	...
	public final class @gesture@Event extends Event
	{
		...
		/**
		 *
		 * Holds a constant to be used once result are retrieved 
		 *
		 */		
		public static const @upperCaseGesture@_RESULT_EVENT:String = "@namespace@.events.@gesture@Event.@upperCaseGesture@_RESULT_EVENT";
