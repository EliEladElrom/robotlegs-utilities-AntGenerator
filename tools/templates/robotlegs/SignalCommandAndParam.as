...
package @namespace@
{
	...
	{
		[Inject]
		public var @camelCaseGesture@:@gesture@;
		...
		override public function execute():void
		{
			...
			// in mediator/presenter use the following code:
			/*
			[Inject]
			public var @camelCaseGesture@Signal:@gesture@Signal;

			var @camelCaseGesture:@gesture@ = new @gesture@();
			@camelCaseGesture@Signal.dispatch(@camelCaseGesture@);
			*/
		}
	}
}